...
// Every route below is admin-only - the one and only place non-self user
// records can be read or changed. Combined with random UUID ids and the
// identity-from-JWT rule in authenticate(), a non-admin has no path to
// another user's record no matter what id they guess or supply.
